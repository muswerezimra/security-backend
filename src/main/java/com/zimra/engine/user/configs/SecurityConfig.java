...
import com.zimra.engine.user.configs.security.IpWhitelistFilter;
import com.zimra.engine.user.configs.security.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        List<String> allowedOrigins = allowedOriginService.getAllowedOrigins();
